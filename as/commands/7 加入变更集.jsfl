...
var tfexe = "C:/Program Files (x86)/Microsoft Visual Studio 10.0/Common7/IDE/tf.exe";
...
if(curUri.indexOf(validateURI) == -1)
{
	...
	{
		var command = '"C:/Program Files (x86)/Microsoft Visual Studio 10.0/Common7/IDE/tf.exe" add '+curUri;
		...
		{
			var command = '"C:/Program Files (x86)/Microsoft Visual Studio 10.0/Common7/IDE/tf.exe" checkout '+tmpfileURI;
			FLfile.runCommandLine(command);
