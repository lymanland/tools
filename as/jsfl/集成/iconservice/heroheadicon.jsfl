...
var picQuality = 80;
var filePrefix = "heroheadicon-";
var libNames = ["英雄头像-大", "英雄头像-中", "英雄头像-小"];
var clsNames = ["mmo.iconservice.res.HeroHeadIcon_L_#raceId#", "mmo.iconservice.res.HeroHeadIcon_M_#raceId#", "mmo.iconservice.res.HeroHeadIcon_S_#raceId#"];
var outputURL = "file:///E|/projectio/dev/source/assets/iconservice/res/heroheadicon_#raceId#.fla";
var defaultRaceId = 0;
var defaultFilePath = "";
...
function exportPetIcon(raceId, filePath)
{
	...
	for each (var item in lib.items)
	{
		if (item.itemType == "bitmap")
		{
			...
			lib.setItemProperty('linkageClassName', "mmo.iconservice.res.HeroHeadIcon_" + raceId + "_tmpBmp_" + bmpCount);
